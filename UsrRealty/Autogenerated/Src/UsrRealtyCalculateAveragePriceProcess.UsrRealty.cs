namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrRealtyCalculateAveragePriceProcessMethodsWrapper

	/// <exclude/>
	public class UsrRealtyCalculateAveragePriceProcessMethodsWrapper : ProcessModel
	{

		public UsrRealtyCalculateAveragePriceProcessMethodsWrapper(Process process)
			: base(process) {
